...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Guildrun Wiki",
    description: "Read the Terms of Service for Guildrun Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Steam game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Guildrun Wiki",
      description: "Terms and conditions for using Guildrun Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Guildrun Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Guildrun Wiki ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Guildrun Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Guildrun Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Steam game "Guildrun". Our services include, but are not limited to:
            </p>
            <ul>
              <li>Hero guides and team build strategies</li>
              <li>Relic and item tier lists</li>
              <li>Specialization and class path information</li>
              <li>Difficulty and Endless mode guides</li>
              <li>Hero and synergy walkthroughs</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Guildrun Wiki is NOT affiliated with, endorsed by, or associated with
              Valve Corporation (Steam) or the official developers of Guildrun. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Guildrun Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Valve Corporation (Steam) and/or the developers of Guildrun. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, GUILDRUN WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Guildrun Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@guildrunwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@guildrunwiki.wiki</a>
            </p>
            <p>
